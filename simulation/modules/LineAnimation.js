class LineAnimation {
  ...
  draw(img) {
    if (this.case == 1) {
      ...
      if (this.startX < this.endX) {
        if (this.currentY < this.endY)
          image(img, this.currentX, this.currentY, 32, 24);
      } else {
        if (this.currentY < this.endY)
          text("ACK", this.currentX, this.currentY - 20);
      }
      ...
      if (this.currentY > this.endY) stroke("#e01919");
      //line color is green if completed
      else stroke(0);
